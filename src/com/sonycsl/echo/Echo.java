...
import com.skyley.skstack_ip.echo.SKEchoDevice;
...
public final class Echo {
    ...
    // Skyeley追加
    private static SKEchoDevice sSKEchoDevice;
    ...
    /**
     * Skyley追加
     * 現在登録されているSKEchoDeviceを返す
     * @return SKEchoDevice
     */
    public static SKEchoDevice getSKEchoDevice() {
    	return sSKEchoDevice;
    }

    /**
     * Skyely追加.
     * SKEchoDeviceを登録
     * @param device SKEchoDevice
     */
    public static void setSKEchoDevice(SKEchoDevice device) {
    	sSKEchoDevice = device;
    }
